...
/** Lucide SquareX — cancel action */
export const iconSquareX = svg(
  '<rect width="18" height="18" x="3" y="3" rx="2"/><path d="m9 9 6 6"/><path d="m15 9-6 6"/>'
);

/** Lucide LoaderCircle — transient loading toast */
export const iconLoaderCircle = svg(
  '<path d="M21 12a9 9 0 1 1-6.219-8.56"/>'
);

/** Lucide ChevronDown — menu and select triggers */
...
/** Lucide BookOpenText — Back to Guides */
export const iconBookOpenText = svg(
...
/** Lucide Form — Back to Forms */
export const iconForm = svg(
